...
"BuildDepthSection[numOfLayers, listH, alpha, len, dx, anoMaxDisp, hTapering]"
...
BuildDepthSection[numOfLayers_, listH_, alpha_, len_, dx_, anoMaxDisp_, hTapering_] := 
Module[{
	horizonNH, 
	anoStartFiltRad = 5, 
	surfStartFiltRad = 5, 
	...
	Return[<|"horizonNH" -> horizonNH, "horNHsorted" -> horNHsorted|>]
]
