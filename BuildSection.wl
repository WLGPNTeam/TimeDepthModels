BuildDepthSection[listH_, alpha_, len_, dx_, anoMaxDisp_, hTapering_] := Module[(*мощности,угол наклона,длина профиля,шаг, степень сглаживания*)
{
    horNH,
    anoStartFiltRad = 5,
    surfStartFiltRad = 5,
...
BuildVelocitySection[horNH_, listV_] := Module[
{
    velModel,
    i, j, dh,
    f,
